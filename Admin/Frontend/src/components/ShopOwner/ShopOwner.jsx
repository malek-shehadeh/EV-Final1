...
//     try {
//       const response = await axios.get("/api/shop-owners");
...
//     try {
//       await axios.patch(`/api/shop-owners/${id}`, { isApproved: newStatus });
...
//                 </td>
//                 <td className="px-6 py-4 whitespace-nowrap">
//                   <div className="text-sm text-gray-300">{owner.shopPhone}</div>
//                 </td>
//                 <td className="px-6 py-4 whitespace-nowrap">
